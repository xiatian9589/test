...
import { IUpdateDelayedEventFromWidgetResponseData, UpdateDelayedEventAction } from "./interfaces/UpdateDelayedEventAction";
...
export declare class WidgetApi extends EventEmitter {
    ...
    sendRoomEvent(eventType: string, content: unknown, roomId?: string, delay?: number, parentDelayId?: string): Promise<ISendEventFromWidgetResponseData>;
     ...
     */
    updateDelayedEvent(delayId: string, action: UpdateDelayedEventAction): Promise<IUpdateDelayedEventFromWidgetResponseData>;
    /**
